...
<head>
    ...
    <title>Karsa ERM | Tutorial General Consent</title>
    ...
    <div class="main-content">
        <div class="page-hero">
            <div class="hero-breadcrumb">
                ...
                <span>Tutorial</span>
                <span>/</span>
                <span style="color: var(--primary); font-weight: 600;">General Consent</span>
            </div>
            <div class="hero-title">
                <h1>📖 Tutorial General Consent (RM 01)</h1>
            </div>
        </div>
        ...
        <div class="content-area">
            <div class="card">
                ...
                <p>1. Masuk ke menu General Consent.<br>2. Cari data pasien berdasarkan nama atau rekam medis.<br>3. Klik tombol input dan lengkapi data penanggung jawab.<br>4. Lakukan penandatanganan elektronik oleh petugas dan pasien.<br>5. Unduh PDF atau kirim hasil persetujuan melalui WhatsApp pasien.</p>
            </div>
        </div>
    </div>
</body>
