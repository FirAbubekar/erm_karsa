...
<head>
    ...
    <title>Karsa ERM | Tutorial RM 10</title>
    ...
    <div class="main-content">
        <div class="page-hero">
            <div class="hero-breadcrumb">
                ...
                <span>Tutorial</span>
                <span>/</span>
                <span style="color: var(--primary); font-weight: 600;">RM 10</span>
            </div>
            <div class="hero-title">
                <h1>📖 Tutorial RM 10</h1>
            </div>
        </div>
        ...
        <div class="content-area">
            <div class="card">
                ...
                <p>Halaman ini berisi petunjuk teknis pengisian modul RM 10. Modul RM 10 digunakan untuk melengkapi riwayat medis terperinci pasien sesuai dengan standar akreditasi rekam medis rumah sakit.</p>
            </div>
        </div>
    </div>
</body>
