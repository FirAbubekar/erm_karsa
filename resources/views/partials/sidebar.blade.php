    ...
    <div class="nav-section">
        ...
        <div class="nav-dropdown {{ Route::is('wa-gateway.*') ? 'active' : '' }}">
            ...
            <div class="nav-dropdown-content">
                <a href="{{ route('wa-gateway.check') }}" class="nav-dropdown-item {{ Route::is('wa-gateway.check') ? 'active' : '' }}">
                    Cek Koneksi
                </a>
                <a href="{{ route('wa-gateway.history') }}" class="nav-dropdown-item {{ Route::is('wa-gateway.history') ? 'active' : '' }}">
                    History WA
                </a>
            </div>
        </div>
        ...
        <a href="{{ route('transfer-pasien.index') }}" class="nav-item {{ Route::is('transfer-pasien.*') ? 'active' : '' }}">
