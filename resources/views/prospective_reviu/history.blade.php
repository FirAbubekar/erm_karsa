...
<head>
    ...
    <title>Karsa ERM | Riwayat Prospective Reviu</title>
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="page-hero">
            <div class="hero-breadcrumb">
                ...
                <span class="current">Riwayat Prospective Reviu</span>
            </div>
            <div class="hero-top">
                <div class="hero-title">
                    <h1>📋 Riwayat Prospective Reviu</h1>
            ...
            <div class="filter-card animate-in">
                ...
                <form action="{{ route('prospective-reviu.history-page') }}" method="GET">
                    ...
                    <div class="filter-actions">
                        @if($activeFilters > 0)
                            <a href="{{ route('prospective-reviu.history-page') }}" class="btn-filter-reset">
            ...
            <div class="table-card animate-in">
                ...
                <div class="table-top-bar">
                    <div class="table-top-bar-left">
                        ...
                        <span class="result-count-badge">{{ $reviews->total() }} dokumen</span>
                    </div>
                </div>
                            ...
                            <tr class="table-row">
                                <td>
                                    <div style="display: flex; flex-direction: column; gap: 4px;">
                                        <div class="surat-badge" title="{{ $review->no_rawat }}">
                                ...
                                <td>
                                    <div class="patient-info">
                                        <div class="patient-avatar">
                                            {{ strtoupper(substr($review->nama_pasien ?? '?', 0, 1)) }}
                                        </div>
                                        <div class="patient-details">
                                            <span class="patient-name">{{ $review->nama_pasien ?? 'Unknown' }}</span>
                                            <span class="patient-rm">{{ $review->no_rm ?? '-' }}</span>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <div class="date-cell">
                                        <span class="date-value">{{ \Carbon\Carbon::parse($review->tanggal_reviu)->format('d M Y') }}</span>
                                        <span class="date-relative">{{ \Carbon\Carbon::parse($review->tanggal_reviu)->diffForHumans() }}</span>
                                    </div>
                                </td>
                                <td>
                                    <span style="font-weight: 600; color: var(--text-secondary);">{{ $review->nama_dpjp }}</span>
                                </td>
                                <td>
                                    <span style="font-weight: 600; color: var(--text-secondary);">{{ $review->ttd_apoteker_klinis }}</span>
                                </td>
                                <td>
                                    <div class="action-group" style="justify-content: center; display: flex; gap: 8px;">
                                        <a href="{{ route('prospective-reviu') }}?id_uuid={{ $review->id_uuid }}"
                                            class="btn-action btn-pdf" style="text-decoration:none;">
                                            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" style="width:16px;height:16px;"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>
                                            Lihat Form
                                        </a>
                                        <a href="{{ route('prospective-reviu.pdf', ['id_uuid' => $review->id_uuid]) }}"
                                            target="_blank"
                                            class="btn-action" style="text-decoration:none; background-color: #f8fafc; color: var(--primary-color); border: 1px solid var(--primary-color);">
                                ...
                                <td colspan="6">
                                    <div class="empty-state">
                                        ...
                                        @if($isDefaultToday)
                                            ...
                                            <a href="{{ route('prospective-reviu.history-page') }}?start_date=&end_date=" class="empty-action">
                                        ...
                                        @else
                                            ...
                                            <a href="{{ route('prospective-reviu.history-page') }}" class="empty-action">
    ...
    <div class="modal-overlay" id="detailModal">
        <div class="modal-panel">
            <div class="modal-top">
                <div>
                    <h3>Detail Prospective Reviu</h3>
