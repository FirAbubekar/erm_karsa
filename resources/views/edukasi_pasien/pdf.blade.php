...
<body>
    ...
    <main>
        ...
        <table class="form-title-table" style="margin-top:-60px !important">
            <tr>
                <td style="width: 50%; font-size:14pt; font-weight:bold" class="text-center">FORMULIR PENGKAJIAN
                    KEBUTUHAN INFORMASI, EDUKASI, PRIVASI PASIEN DAN KELUARGA</td>
                <td style="width: 50%;">
                    <table>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="colon" style="border: none;">:</td>
                            <td style="border: none;">{{ $assessment->regPeriksa->pasien->nm_pasien ?? '-' }} /
                                &nbsp;&nbsp;&nbsp; {{ ($assessment->regPeriksa->pasien->jk ?? '') == 'L' ? 'L' : 'P' }}
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="border: none;">
                                {{ isset($assessment->regPeriksa->pasien->tgl_lahir) ? date('d-m-Y', strtotime($assessment->regPeriksa->pasien->tgl_lahir)) : '-' }}
                            </td>
                        </tr>
                        <tr>
            ...
            <tr>
                <td colspan="2"
                    style="padding: 2px 4px; background-color: #ddd; font-weight: bold; text-align: center;">
                    <span class="checkbox">{!! str_contains($assessment->regPeriksa->status_lanjut ?? '', 'Ralan') &&
                    $assessment->regPeriksa->kd_poli != 'IGDK'
                        ? 'V'
                        : '&nbsp;' !!}</span> RAWAT JALAN &nbsp;&nbsp;&nbsp;
        ...
        <table class="main-table">
            <tr>
                <td colspan="2" style="border-bottom:none;">
                    <table style="width:100%; font-size:8pt; border-collapse:collapse;">
                        <tr>
                            <td style="width: 140px; border: none;">Nama Penerima Informasi</td>
                            <td style="border: none;">: {{ $assessment->nama_penerima_info }}</td>
                        </tr>
                        <tr>
                            <td style="border: none;">Hubungan dengan Pasien</td>
                            <td style="border: none;">: {{ $assessment->hubungan_dgn_pasien }}</td>
                        </tr>
                    </table>
                </td>
            </tr>
            ...
            <tr>
                <td colspan="2" style="padding: 4px 8px;">
                    <div style="margin-bottom: 4px;"><strong>DATA PASIEN</strong> (Beri tanda <span
                            class="checkbox">V</span> pada kotak yang sesuai)</div>
                    ...
                    <table style="width: 100%; border-collapse: collapse; font-size: 8pt;">
                        <tr>
                            ...
                            <td style="border: none;">:
                                ...
                                &nbsp;
                                <span class="checkbox">{!! in_array('Daerah', $bahasa) ? 'V' : '&nbsp;' !!}</span> Daerah:
                                {{ in_array('Daerah', $bahasa) ? $assessment->bahasa_lainnya : '..........' }}
                                &nbsp;
                                <span class="checkbox">{!! in_array('Lain-lain', $bahasa) ? 'V' : '&nbsp;' !!}</span> Lain-lain:
                                {{ in_array('Lain-lain', $bahasa) ? $assessment->bahasa_lainnya : '..........' }}
                            </td>
                        </tr>
                        <tr>
                                ...
                                <table style="width: 100%; border-collapse: collapse;">
                                    <tr>
                                        <td style="border: none;">: <span
                                                class="checkbox">{!! in_array('Tidak Ada', $hambatan) ? 'V' : '&nbsp;' !!}</span> Tidak Ada</td>
                                        <td style="border: none;"><span
                                                class="checkbox">{!! in_array('Penglihatan', $hambatan) ? 'V' : '&nbsp;' !!}</span> Penglihatan</td>
                                        <td style="border: none;"><span
                                                class="checkbox">{!! in_array('Bahasa', $hambatan) ? 'V' : '&nbsp;' !!}</span> Bahasa</td>
                                        <td style="border: none;"><span
                                                class="checkbox">{!! in_array('Kognitif Terbatas', $hambatan) ? 'V' : '&nbsp;' !!}</span> Kognitif Terbatas</td>
                                    </tr>
                                    <tr>
                                        <td style="border: none;">&nbsp; <span
                                                class="checkbox">{!! in_array('Emosional terganggu', $hambatan) ? 'V' : '&nbsp;' !!}</span> Emosional terganggu
                                        </td>
                                        <td style="border: none;"><span
                                                class="checkbox">{!! in_array('Budaya/Agama', $hambatan) ? 'V' : '&nbsp;' !!}</span> Budaya/Agama</td>
                                        <td style="border: none;"><span
                                                class="checkbox">{!! in_array('Motivasi Kurang', $hambatan) ? 'V' : '&nbsp;' !!}</span> Motivasi Kurang</td>
                                        <td style="border: none;"><span
                                                class="checkbox">{!! in_array('Pendengaran Terganggu', $hambatan) ? 'V' : '&nbsp;' !!}</span> Pendengaran Terganggu
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="border: none;">&nbsp; <span
                                                class="checkbox">{!! in_array('Gangguan Bicara', $hambatan) ? 'V' : '&nbsp;' !!}</span> Gangguan Bicara</td>
                                        <td style="border: none;"><span
                                                class="checkbox">{!! in_array('Fisik Lemah', $hambatan) ? 'V' : '&nbsp;' !!}</span> Fisik Lemah</td>
                                        <td style="border: none;" colspan="2"><span
                                                class="checkbox">{!! in_array('Lain-lain', $hambatan) ? 'V' : '&nbsp;' !!}</span> Lain-lain:
                                            {{ in_array('Lain-lain', $hambatan) ? $assessment->hambatan_lainnya : '..........' }}
                                        </td>
                                    </tr>
                                </table>
                            </td>
                ...
                <td colspan="2" style="padding: 4px;">
                    ...
                    <table style="width: 100%; border-collapse: collapse; font-size: 8pt;">
                        <tr style="border: none;">
                            <td style="width: 33%; border: none;"><span
                                    class="checkbox">{!! in_array('B_HAK_PARTISIPASI', $rencana) ? 'V' : '&nbsp;' !!}</span> Hak untuk Berpartisipasi pada
                                Proses Pelayanan </td>
                            <td style="width: 33%; border: none;"><span
                                    class="checkbox">{!! in_array('B_PROSEDUR_PENUNJANG', $rencana) ? 'V' : '&nbsp;' !!}</span> Prosedur Pemeriksaan Penunjang
                            </td>
                            <td style="width: 33%; border: none;"><span
                                    class="checkbox">{!! in_array('B_DIAGNOSIS', $rencana) ? 'V' : '&nbsp;' !!}</span> Kondisi Kesehatan, Diagnosis
                                pasti, dan penatalaksanaannya</td>
                        </tr>
                        <tr style="border: none;">
                            <td style="border: none;"><span class="checkbox">{!! in_array('B_INFORMED_CONSENT', $rencana) ? 'V' : '&nbsp;' !!}</span> Proses
                                Pemberian Informed Consent</td>
                            <td style="border: none;"><span class="checkbox">{!! in_array('B_DIET_NUTRISI', $rencana) ? 'V' : '&nbsp;' !!}</span> Diet dan
                                Nutrisi</td>
                            <td style="border: none;"><span class="checkbox">{!! in_array('B_OBAT', $rencana) ? 'V' : '&nbsp;' !!}</span>
                                Penggunaan Obat secara Efektif dan Aman, Efek Samping serta Interaksinya </td>
                        </tr>
                        <tr style="border: none;">
                            <td style="border: none;"><span class="checkbox">{!! in_array('B_ALAT_MEDIS', $rencana) ? 'V' : '&nbsp;' !!}</span>
                                Penggunaan Alat Medis yang Aman</td>
                            <td style="border: none;"><span class="checkbox">{!! in_array('B_MANAJEMEN_NYERI', $rencana) ? 'V' : '&nbsp;' !!}</span> Manajemen
                                Nyeri</td>
                            <td style="border: none;" rowspan="2"><span
                                    class="checkbox">{!! in_array('B_REHABILITASI', $rencana) ? 'V' : '&nbsp;' !!}</span> Teknik Rehabilitasi</td>
                        </tr>
                        <tr style="border: none;">
                            <td style="border: none;"><span class="checkbox">{!! in_array('B_CUCI_TANGAN', $rencana) ? 'V' : '&nbsp;' !!}</span> Cuci
                                Tangan yang Benar</td>
                            <td style="border: none;"><span class="checkbox">{!! in_array('B_BAHAYA_ROKOK', $rencana) ? 'V' : '&nbsp;' !!}</span> Bahaya
                                Rokok</td>
                        </tr>
                        <tr style="border: none;">
                            <td style="border: none;"><span class="checkbox">{!! in_array('B_RUJUKAN', $rencana) ? 'V' : '&nbsp;' !!}</span> Rujukan
                                Edukasi</td>
                            <td style="border: none;"><span class="checkbox">{!! in_array('B_EDUKASI_PULANG', $rencana) ? 'V' : '&nbsp;' !!}</span> Edukasi
                                Pasien Pulang</td>
                            <td style="border: none;"><span class="checkbox">{!! in_array('B_LAINNYA', $rencana) ? 'V' : '&nbsp;' !!}</span>
                                Lain-lain: {{ $assessment->rencana_lainnya }}</td>
                        </tr>
                    </table>
                </td>
            </tr>
            <tr>
                <td colspan="2" style="border-top: none;">
                    <div style="float: left; width: 50%;">
                        Tanggal Edukasi:
                        {{ $assessment->updated_at ? date('d-m-Y', strtotime($assessment->updated_at)) : '' }}<br>
                        Nama: {{ $assessment->nama_penerima_info }}
                    </div>
                    <div style="float: right; width: 40%; text-align: center;">
                        Tanda Tangan:<br>
                        @if ($assessment->ttd_pasien_wali)
                            <img src="{{ storage_path('app/private/' . $assessment->ttd_pasien_wali) }}"
                                alt="ttd" class="signature-image" style="max-height: 40px; margin-top:5px;">
                            <div style="font-size: 8pt; margin-top: 2px;">
                                ({{ $assessment->nama_penerima_info ?? $assessment->nama_pasien_wali_ttd }})</div>
                        @else
            ...
            <tr>
                <td style="width: 50%; padding: 0;">
                    <table style="width: 100%; border-collapse: collapse; font-size: 7.5pt;">
                        <tr>
                            <td style="border-bottom: 1px solid #000; border-right: 1px solid #000; padding: 2px 4px; "
                                class="text-center">Tujuan Edukasi :</td>
                            <td style="border-bottom: 1px solid #000; padding: 2px 4px; " class="text-center">Metode
                                Edukasi :</td>
                        </tr>
                        <tr>
                ...
                <td style="width: 50%; padding: 0;">
                    <table style="width: 100%; border-collapse: collapse; font-size: 7.5pt;">
                        <tr>
                            <td style="border-bottom: 1px solid #000; border-right: 1px solid #000; padding: 2px 4px; "
                                class="text-center">Materi Edukasi :</td>
                            <td style="border-bottom: 1px solid #000; padding: 2px 4px; " class="text-center">Evaluasi
                                :</td>
                        </tr>
                        <tr>
                            <td style="border-right: 1px solid #000; padding: 2px 4px;  vertical-align: top;">
        ...
        <table class="edukasi-table">
            ...
            <tbody>
                @foreach ($implementations as $impl)
                    @php
                        $verifikasi = is_string($impl->verifikasi)
                            ? json_decode($impl->verifikasi, true)
                            : $impl->verifikasi;
                        if (!is_array($verifikasi)) {
                            $verifikasi = [];
                        }
                    @endphp
                    <tr>
                        ...
                        <td style="">
                            <table>
                                @php
                                    $valTujuan = '&nbsp;';
                                    if (isset($verifikasi['Tujuan'])) {
                                        $valTujuan = $verifikasi['Tujuan'];
                                    } elseif (in_array('Tujuan', $verifikasi)) {
                                        $valTujuan = 'V';
                                    }

                                    $valMetode = '&nbsp;';
                                    if (isset($verifikasi['Metode'])) {
                                        $valMetode = $verifikasi['Metode'];
                                    } elseif (in_array('Metode', $verifikasi)) {
                                        $valMetode = 'V';
                                    }

                                    $valMateri = '&nbsp;';
                                    if (isset($verifikasi['Materi'])) {
                                        $valMateri = $verifikasi['Materi'];
                                    } elseif (in_array('Materi', $verifikasi)) {
                                        $valMateri = 'V';
                                    }

                                    $valEvaluasi = '&nbsp;';
                                    if (isset($verifikasi['Evaluasi'])) {
                                        $valEvaluasi = $verifikasi['Evaluasi'];
                                    } elseif (in_array('Evaluasi', $verifikasi)) {
                                        $valEvaluasi = 'V';
                                    }
                                @endphp
                                <tr>
                                    <td style="border:none;">Tujuan Edukasi</td>
                                    <td class="text-center" style="border:none;"><span class="checkbox"
                                            style="color:#000;">{!! $valTujuan !!}</span></td>
                                </tr>
                                <tr>
                                    <td style="border:none;">Metode Edukasi</td>
                                    <td class="text-center" style="border:none;"><span class="checkbox"
                                            style="color:#000;">{!! $valMetode !!}</span></td>
                                </tr>
                                <tr>
                                    <td style="border:none;">Material Edukasi</td>
                                    <td class="text-center" style="border:none;"><span class="checkbox"
                                            style="color:#000;">{!! $valMateri !!}</span></td>
                                </tr>
                                <tr>
                                    <td style="border:none;">Evaluasi</td>
                                    <td class="text-center" style="border:none;"><span class="checkbox"
                                            style="color:#000;">{!! $valEvaluasi !!}</span></td>
                                </tr>
                            </table>
                        ...
                        <td class="text-center" style="vertical-align: middle;">
                            @if ($impl->ttd_pasien)
                                <img src="{{ storage_path('app/private/' . $impl->ttd_pasien) }}"
                                    style="max-height: 40px; max-width: 100%; object-fit: contain;">
                                <div style="font-size: 6pt; margin-top: 2px;">
                                    ({{ $impl->nama_penerima_info ?? ($assessment->nama_penerima_info ?? $assessment->nama_pasien_wali_ttd) }})
                                </div>
                            @endif
                        </td>
                        <td class="text-center" style="vertical-align: middle;">
                            @if ($impl->ttd_edukator)
                                ...
                                @endphp
                                @if (str_contains($impl->ttd_edukator, 'education/'))
                                    <img src="{{ public_path('storage/' . $impl->ttd_edukator) }}"
                                        style="max-height: 40px; max-width: 100%; object-fit: contain;">
                                @else
                                    @php
                        ...
                        <td class="text-center">
                            {{ $impl->tgl_reedukasi ? date('d/m/y', strtotime($impl->tgl_reedukasi)) : '' }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
    ...
    <script type="text/php">
        if (isset($pdf)) {
            $text = "RM. 010B/{PAGE_NUM}-{PAGE_COUNT}/Rev 1";
            $dummy_text = "RM. 010B/9-9/Rev 1"; // Used for width calculation to avoid {PAGE_NUM} string length inflation
